 ...
 *
 * No account required. DESIGN.md §8.4 — "never gate the magic behind a signup
 * wall" — and drawing is the magic; the work autosaves locally and exports to
 * a file whether or not anyone is signed in.
 */
